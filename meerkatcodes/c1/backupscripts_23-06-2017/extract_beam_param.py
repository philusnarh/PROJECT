...
cachefile = 'beamfits-mearkat_mb2_scaled_down_to_em_grid-clip-%s.cp'%clip
...
for ifname in ['000', '012', '017']:
    ...
    fileReal = path + '1487813282_m%s_900MHz_1MHz_500channels_Jones_mb2_scaled_down_to_em_grid_XX_re.fits'%ifname
    fileImag = path + '1487813282_m%s_900MHz_1MHz_500channels_Jones_mb2_scaled_down_to_em_grid_XX_im.fits'%ifname
    ...
    fileReal = path + '1487813282_m%s_900MHz_1MHz_500channels_Jones_mb2_scaled_down_to_em_grid_YY_re.fits'%ifname
    fileImag = path + '1487813282_m%s_900MHz_1MHz_500channels_Jones_mb2_scaled_down_to_em_grid_YY_im.fits'%ifname
