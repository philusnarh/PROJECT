...
f_radio = pyfits.open("Foreground_Gridding__300MHz_I.fits") #ic443.cont.clean_gull.immerge.nan.fits

# Jy -> mJy
data = f_radio[0].data   # f_radio[0].data*1000
...
# draw image
im = ax.imshow(data, cmap=plt.get_cmap('jet'), origin="lower", interpolation="lanczos")
#im.set_clim(0, 115)
...
cax.set_ylabel("Jy/Pixel") #mJy/Beam
ax.set(xlim=(100, 510), ylim=(100, 510))
