...
def fill_table(tname=None,xy_file=None,use=[1,2],name="NAME",position="POSITION",mount="MOUNT",offset="OFFSET",station="STATION",typE="TYPE",dish_diameter="DISH_DIAMETER",flag="FLAG_ROW"):
...
if __name__=="__main__" :
        ...
        opt.set_description("Creates an antenna table and/or MS given an antenna layout (provide a configuration file to make MS, --conf and the MS name in the conf. file --msname")
        opt.add_option('--layout',dest='layout',default=None,help='layout file')
	opt.add_option("--use", dest="use",default="1,2",help='x and y columns of layout, default is 1,2')
        opt.add_option('--tname',dest='tname',default=None,help='Antenna table name')
        opt.add_option('--conf',dest='conf',default=None,help='configuration file name')
        opt.add_option('--msname',dest='msname',default=None,help='Name of measurement set')
