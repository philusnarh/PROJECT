...
for ant in ANTS[:] :
	...
	x = xcr1[ichan] + rr[ant].xw.data[ichan]*(numpy.arange(xpl) - xcr2[terget_chan])/(sr.xw[terget_chan]*1.0)
	y = ycr1[ichan] + rr[ant].yw.data[ichan]*(numpy.arange(ypl) - ycr2[terget_chan])/(sr.yw[terget_chan]*1.0)
	...
	x = xcl1[ichan] + ll[ant].xw.data[ichan]*(numpy.arange(xpl) - xcl2[terget_chan])/(sl.xw[terget_chan]*1.0)
	y = ycl1[ichan] + ll[ant].yw.data[ichan]*(numpy.arange(ypl) - ycl2[terget_chan])/(sl.yw[terget_chan]*1.0)
