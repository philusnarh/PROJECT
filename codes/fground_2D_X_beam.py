from ap_array_modelclass import *
import glob
import pyfits 
import pywcsgrid2
import pywcs
...
def run_test():
    ...
    #
    tru_image_data, h = foregroundGrid_x_beam('foreground_map.fits', 'mueller_4_x_4_beam.fits')
    pyfits.writeto('for_grid_x_trubeam.fits', tru_image_data, h, clobber=True)
    fu1 = figur(1, 12, 12, 80)
    Mueller_image(fu1, h[0:38], 4, 4, 16 , tru_image_data ,'fgrid_x_trubeam_4_X_4_Imagestry1.png')
    # 
    # 	Multiply Foreground Grid by Distorted Primary Beam
    #
    dis_image_data, h = foregroundGrid_x_beam('foreground_map.fits', 'dis_mueller_4_x_4_beam.fits')
    pyfits.writeto('for_grid_x_dis_beam.fits', dis_image_data, h, clobber=True)
    fu2 = figur(2, 12, 12, 80)
    Mueller_image(fu2, h[0:38], 4, 4, 16 ,dis_image_data ,'fgrid_x_dis_beam_4_X_4_Imagestry2.png')
    #
    ...
    Mueller_image(fu3, h, 4, 4, 16 , map_difference ,'multiplicative_diff.png')
    # 
    ...
    Mueller_image(fu4, h, 4, 4, 16 , mapp ,'mapp_diff.png')
