...
def run_sim_test():
	...
	ra_crval1, dec_crval2 = azel2radec(az = -34.91, el = 50.96 , lat = -30.7214, 
	...
	# 	  '/home/narh/meerkat-hbeam/1487813282_m017_900MHz_1MHz_500channels_Jones.npy']
  	...
  	#
  	bm = ['/home/narh/beam/holography/hbeam/1487813282_m000_856MHz_1MHz_857channels_Jones.npy',
		  '/home/narh/beam/holography/hbeam/1487813282_m012_856MHz_1MHz_857channels_Jones.npy',
		  '/home/narh/beam/holography/hbeam/1487813282_m017_856MHz_1MHz_857channels_Jones.npy'] # 

  	bmf = ['/home/narh/beam/holography/hbeam/1487813282_m00_900MHz_1MHz_500channels_Jones.npy', 
    		'/home/narh/beam/holography/hbeam/1487813282_m012_900MHz_1MHz_500channels_Jones.npy',
		  '/home/narh/beam/holography/hbeam/1487813282_m017_900MHz_1MHz_500channels_Jones.npy']
	...
	for iter in xrange(len(bm)):
		...
		pyfits.writeto('%s_XX_re.fits' %(os.path.basename(bmf[iter][:-4])), Gxx.real, header=header, clobber=True)
		pyfits.writeto('%s_XY_re.fits' %(os.path.basename(bmf[iter][:-4])), Gxy.real, header=header, clobber=True)
		pyfits.writeto('%s_YX_re.fits' %(os.path.basename(bmf[iter][:-4])), Gyx.real, header=header, clobber=True)
		pyfits.writeto('%s_YY_re.fits' %(os.path.basename(bmf[iter][:-4])), Gyy.real, header=header, clobber=True)
		pyfits.writeto('%s_XX_im.fits' %(os.path.basename(bmf[iter][:-4])), Gxx.imag, header=header, clobber=True)
		pyfits.writeto('%s_XY_im.fits' %(os.path.basename(bmf[iter][:-4])), Gxy.imag, header=header, clobber=True)
		pyfits.writeto('%s_YX_im.fits' %(os.path.basename(bmf[iter][:-4])), Gyx.imag, header=header, clobber=True)
		pyfits.writeto('%s_YY_im.fits' %(os.path.basename(bmf[iter][:-4])), Gyy.imag, header=header, clobber=True)

	os.mkdir('%s' %('newbeams'))
	os.system('mv %s %s'   %('*fits', 'newbeams'))
